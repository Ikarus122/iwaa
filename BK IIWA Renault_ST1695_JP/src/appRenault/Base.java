...
public class Base extends RoboticsAPIApplication
{
	...
	public void run()
	{
		...
		if (Shared.iExtension.getRbtPos1() && !Shared.iExtension.getRbtPos2())
		{
			...
			// Si está en Home, puede moverse a los puntos
			if (isInFrame(Shared.robot.getFlange(), Shared.HOME, 10.0))
			{
				...
				getApplicationUI().displayModalDialog(ApplicationDialogType.INFORMATION
								, "Confirmar que el robot está en el punto 'Origen' de la base y pulsar continuar para ir al siguiente punto."
								, "Continuar");
				...
				// Se para el programa para ver que el robot está correctamente en el punto
				getApplicationUI().displayModalDialog(ApplicationDialogType.INFORMATION
								, "Confirmar que el robot está en el punto 'Posición X positiva' de la base y pulsar continuar para ir al siguiente punto."
								, "Continuar");
				...
				// Se para el programa para ver que el robot está correctamente en el punto
				getApplicationUI().displayModalDialog(ApplicationDialogType.INFORMATION
								, "Confirmar que el robot está en el punto 'Posición Y positiva' de la base y pulsar continuar para volver a Home."
								, "Continuar");
			...
			{
				getAppLogger().error("El robot no está en Home. No puede ir a los puntos de la base.");
				return;
			}
		}
	}
